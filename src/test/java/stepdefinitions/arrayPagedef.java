...
public class arrayPagedef {
	...
	public void the_user_selects_array_item_from_the_drop_down_menu() {
	    	}
...
public void the_user_should_not_get_any_error_message() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
...
public void the_user_clicks_try_here_button_in_appliactions_of_array_page() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
...
public void the_user_should_be_redirected_to_search_the_array_page() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
...
public void the_user_should_be_redirected_to_max_consecutive_ones_page() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}

@When("The user clicks Find Numbers with Even Numbers of Digits link")
public void the_user_clicks_find_numbers_with_even_numbers_of_digits_link() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}

@Then("The user should be redirected to Find Numbers with Even Numbers of Digits page")
public void the_user_should_be_redirected_to_find_numbers_with_even_numbers_of_digits_page() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
...
public void the_user_should_be_redirected_to_squares_of_a_sorted_array_page() {
    // Write code here that turns the phrase above into concrete actions
    throw new io.cucumber.java.PendingException();
}
